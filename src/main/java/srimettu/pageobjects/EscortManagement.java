...
public class EscortManagement extends AbstractComponent {
	...
	/*
	 * public void selesctr() throws InterruptedException{ selescoter.click();
	 * List<WebElement> escorters =
	 * driver.findElements(By.xpath("//div/ul[2]/li/div")); for (WebElement
	 * escorter:escorters) { if (escorter.getText().equalsIgnoreCase("s02 test")) {
	 * escorter.click(); break; } }
	 * 
	 * Thread.sleep(2000); } public void selesctee() throws InterruptedException{
	 * selescortee.click(); List<WebElement> escortees =
	 * driver.findElements(By.xpath("//div/ul[2]/li/div")); for (WebElement
	 * escortee:escortees) { if (escortee.getText().equalsIgnoreCase("u 596e")) {
	 * escortee.click(); break; } ; } multiselect2.click(); //selescortee.click();
	 * Thread.sleep(2000); }
	 * 
	 * public void seldestination() throws InterruptedException{ seldest.click();
	 * List<WebElement> destinations =
	 * driver.findElements(By.xpath("//div/ul[2]/li/div")); for (WebElement
	 * destination:destinations) { if
	 * (destination.getText().equalsIgnoreCase("Andy-Desk")) {
	 * 
	 * destination.click(); break; }
	 * 
	 * } //multiselect3.click(); Thread.sleep(2000); }
	 */
}
